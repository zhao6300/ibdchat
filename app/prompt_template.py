...
def load_prompt(name: str) -> str:
    ...
    if not os.path.isfile(path):
        raise FileNotFoundError(
            f"Prompt file '{name}.md' not found in prompts/ directory.")
...
HALLUCINATOR_PROMPT_TEMPLATE = load_prompt("hallucination_grader")
ANSWER_GRADER_ROMPT_TEMPLATE = load_prompt("answer_grader")
